...
===============================| Vega by Phantom.of.the.Server |===============================
 ...
 - Customized version of Capcom's Vega (M. Bison) character from the Street Fighter series
...
==========< FEATURES >==========
 ...
 - Special intro vs KarmaCharmeleon's Iori
 - Custom input parser
 - A.I.
...
.Psycho Crusher (EX)              (charge) B, F, p
.Double Knee Press (EX)           (charge) B, F, k
.Head Press (EX)                  (charge) D, U, k
   .Somersault Skull Diver        p
.Devil Reverse (EX)               (charge) D, U, p, p
.Psycho Field (EX)                F, D, B, p
.Psycho Impact (EX)               B, D, F, p
.Vega Warp Forward                F, D, DF, pp/kk
.Vega Warp Backward               B, D, DB, pp/kk


<LEVEL 1 SUPER COMBOS>

.Nightmare Booster                (charge) B, F, B, F, p
.Knee Press Nightmare             (charge) B, F, B, F, k
.Psycho Cannon                    D, DB, B, D, DB, B, p (charge)


<LEVEL 2 SUPER COMBOS>

.Psycho Break Smasher             (charge) B, F, B, F, pp


<LEVEL 3 SUPER COMBOS>

.Final Psycho Crusher             (charge) DB, DF, DB, U, pp
...
.Guard Cancel (Teleport)          F + kk (during guard) (1 power bar)
.Fall Recovery                    p / k (while falling from a hit)
.Low Jump                         U (tap)
.High Jump                        D, U
.Taunt                            s
.Delayed Vega Warp                Perform Vega Warp with the Start button and hold it



==========< MOVE DETAILS >==========

 - Psycho Banish can hit some projectiles

 - Psycho Crusher destroys normal projectiles (like Megaman's)

 - Nightmare Booster destroys normal and special projectiles

 - Psycho Break Smasher and Final Psycho Crusher destroy any projectiles

 - Head Press can be used as a pursuit attack, to hit downed opponents

 - Somersault Skull Diver and Devil Reverse can be manually steered with the forward and backward directions

 - EX Head Press and EX Devil Reverse trigger the same move

 - Delayed Vega Warp has no startup invincibility

 - Psycho Field disappears if Vega gets hit

 - Psycho Impact will plant a Psycho Mine on the opponent if it connects

 - Psycho Mine will explode after a certain amount of time or after certain moves connect
...
<27.09.2024>
 ...
 - Adjusted Psycho Impact physics
 - Psycho Impact now plants a Psycho Mine on the enemy
 - Psycho Impact second hit is no longer super cancellable
 - EX Psycho Impact no longer wall bounces
 - Simplified Head Press enemy tracking formula so that it may hit crouchers more reliably
 - Changed Psycho Field special effects
 - Restored the ability to perform EX and super moves at the the end of Custom Combo
 - Psycho Banish reworked into an overhead attack
 - EX Psycho Crusher now does 3 hits
 - Removed neutral jumping medium punch variation
 - Jumping medium punch now causes a free juggle state
...
<30.07.2023>
 ...
 - Psycho Banish can absorb one hit of special fireballs (again)
 ...
 - Added special intro versus KarmaCharmeleon's Iori Yagami
 - Double Knee Press reworked to be a little more like SF5. No longer knocks down
 - Cannot use Psycho Cannon while a Psycho Field is active
 - Adjusted the default flame color to be more like my later characters
 - Final Psycho Crusher effects now partially change colors according to the palette
 - Lowered Psycho Crusher's guard bar damage
 - Changed Custom Combo damage scaling
 - Removed the ability to perform EX and super moves at the end of Custom Combo
 - Head Press tracks a bit better against crouching opponents
...
<19.03.2023>
 ...
 - Final Psycho Crusher does a few more hits
 - Changed Vega Warp sound effect
 ...
 - The camera movement in Final Psycho Crusher is now handled by a (fake) zooming effect
 - Most intros now respect the lifebar's waiting time
 - Improved the Psycho Cannon graphics
 - Adjusted corner crossups so that they're less ambiguous
 - Added a couple of palettes
...
<11.09.2022>
 - Bug fixing
 - EX Psycho Field now detonates upon contact with the opponent rather than by proximity
 - Adjusted projectile armor of all Psycho Crusher type attacks. See Move Details section
 - The A.I. will now use EX specials as well
 ...
 - Added JMorphman's special intro against Violent Ken
 - The character now flashes white to signal a super cancel

<03.07.2022>
 - Bug fixing
 - Psycho Banish reworked into a command normal similar in functionality to Psycho Axe
 - Medium and strong Psycho Impact have faster startup, but all versions are less safe on block
 - Final Psycho Crusher input is more lenient
 - Final Psycho Crusher has a bit less startup since the new camera code allows the opponent more time to block
 - Vega Warp now travels farther with kicks than with punches
 - Vega Warp has a bit less recovery
 - Removed the Custom Combo version of Vega Warp, since it was a gimmick without practical use
 - Added EX versions to all special moves (except Vega Warp)
 - Vega Warp command changed to PPP or KKK to avoid overlapping the new EX moves
...
<12.06.2022>
 ...
 - Camera effect code for Final Psycho Crusher simplified thanks to Ikemen GO's new features
 - Changed tag out animation
 - Damage scaling is now similar to modern Street Fighter games

<11.06.2022>
 - Bug fixing
 - Adjusted throw escape behaviour
 - Can no longer super cancel Nightmare Booster
...
<30.04.2022>
 ...
 - Changed direction handling for Devil Reverse
...
<15.04.2022>
 - Psycho Crusher and Psycho Break Smasher trigger the burned animation on the opponent if they have one
 ...
 - Changed most super inputs to charge motions
 - Removed dragon punch motion shortcuts for better Ikemen compatibility
 - Adjusted velocity control during Somersault Skull Diver

<02.04.2022>
 - Bug fixing
 - Adjusted Head Press hitbox
 - Vega no longer teleports to the opponent's position after connecting Head Press
 ...
 - Can no longer charge from a neutral position by holding opposite directions
...
<05.03.2022>
 ...
 - Parrying Head Press makes it miss instead of continuing
...
<26.02.2022>
 ...
 - Adjusted timing and ranges of Psycho Field
 - Vega Warp can now only be delayed if performed with the Start button
 - Taunt version of the teleport stays in place
 - Psycho Field has less recovery time and the distance travelled by the projectile is slightly different
 - Psycho Field now pushes the opponent back when hitting behind him
 - Psycho Field stays active even if it goes outside the screen
 - Psycho Field can hit downed opponents
 - Psycho Field damage lowered a bit since it's now overall a better move
 - Normal punch "Psycho Power" sound effect now has light, medium and heavy variations
 - Psycho Banish can absorb hits from super projectiles as well, if you're brave enough to try
 - Double Knee Press and Knee Press Nightmare can be super cancelled even if Vega's feet are off the ground
 - Changed Psycho Break Smasher damage distribution to make it more effective when only a few hits connect
 - Psycho Banish can be blocked standing
 - Added forward dash
 - Tweaked flying intro to work on stages without super jump
 - Heartbreak Despair replaced with Nightmare Booster
 - Added Psycho Cannon
 - Added a few SF4 sounds
 - The follow-up to Knee Press Nightmare is no longer a separate move, as that was redundant
 - Psycho Crusher deals multiple hits during Custom Combos
 - Changed jump arc to SSF2T (Turbo 1)
 - Final Psycho Crusher now has a camera effect like the source
 - Vega now hovers while walking back, as in SFA
 - Added electrocution and a few missing special get hit animations
 - Reduced the range on Psycho Impact, since it made no sense to have more than his charge moves
 - Psycho Impact no longer automatically punches when near the opponent, so there's a reason to use the faster weak versions
 - Removed "Reversal" Vega Warp
 - Fixed "Psycho Power" in normal punches disappearing sooner than intended
 - Roll is more accurate
 - Back roll is slower than forward roll
 - Head Press is faster
...
<v.0.9>
 ...
 - No longer needs to charge Super moves during Custom Combo
 - Added (sloppy) A.I.
 - Added some palettes
...
==========< SPECIAL THANKS >==========
 ...
 - Edward_The_Great, JustNoPoint, Messatsu, PeXXeR, Sennou-Room, Snake, Toni, Warusaki3, XDIeTryiNG and ZolidSone for feedback
 - JustNoPoint, for ripping Vega's sprites, among other stuff from CvS2
 - H" and Warusaki3 for their CvS2 effects
 - Mysticus, for several SF4 sounds
