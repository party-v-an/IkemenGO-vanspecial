...
===============================| Cammy by Phantom.of.the.Server |==============================
 ...
 - Customized version of Capcom's Cammy White character from the Street Fighter series
...
<Normal Cammy>
 - Cammy as we know her from her days serving Shadaloo

<Doll Cammy>
 - Based on Juni and Juli for the most part
 - Selectable by holding start in the select screen
...
.Hooligan Suplex                   F/B + pp
.Frankensteiner                    F/B + kk
.Flying Neck Hunt                  F/B + pp   (air)
.Air Frankensteiner                F/B + kk   (air)


<UNIQUE ATTACKS - NORMAL MODE>

Knee Bullet                        F + c


<UNIQUE ATTACKS - DOLL MODE>
...
.Spin Drive Smasher (MAX)          D, DF, F, D, DF, k
.Reverse Shaft Breaker (MAX)       D, DB, B, D, DB, k   (mash buttons for more hits)
.Sniping Heel (MAX)                D, DF, F, D, DF, p
    .High                          p
    .Low                           k
...
.Killer Bee Assault                D, DB, B, D, DB, pp
...
==========< MOVE DETAILS >==========
 ...
 - Fallig Arc is an overhead
 - Close hard kick can be jump cancelled
...
opponent is too far up or if you selected Doll mode
...
==========< MISCELLANEOUS NOTES >==========
 ...
 - Psycho Streak cannot be performed if there's another Vega/M. Bison on screen
...
<27.09.2024>
 ...
 - Some frame data adjustments
 - EX Axle Spin Knuckle no longer wall bounces
 - Removed the first hit from hard Cannon Drill
 - Cannon Drill animations raised a bit higher above the ground
 - EX Cannon Spike no longer jumps back on hit or block
...
<22.04.2024>
 ...
 - Adjusted Cannon Strike frame data
...
<05.10.2023>
 ...
 - Hooligan Sting no longer knocks down
 - Buffed super combo damage
 - Adjusted Psycho Streak juggle potential
 - Implemented maximum damage scaling for supers
 - Psycho Streak can now be used against Vega
 - Cammy will now also salute Vega if he's on the same team
 ...
 - The counters now only work if the opponent is in front of Cammy
 - Close hard punch is activated further away from the opponent
 - Sniping Heel no longer does the followup automatically during super cancels
 - Sniping Heel now allows a free juggle when hitting air to air
...
<30.07.2023>
 ...
 - Hooligan Combination no longer triggers proximity block
 - Added some fire hit sounds
 - Revised super pause times
 - Punch followup of Sniping Heel has lower body invincibility
 - Sniping Heel followups can be executed by simply holding the respective button
 ...
 - Standing hurtboxes are slightly wider
...
<19.03.2023>
 ...
 - All Killer Bee Assault strikes are now invincible to fireballs
 ...
 - Lowered Air Cannon Drill height restriction

<11.09.2022>
 - Bug fixing
 - Added an experimental victory BGM
 - Fixed Killer Bee Assault (wall version) behaviour during zoom
 - The A.I. now uses the new command normals
 - During Psycho Streak, Vega no longer performs his Psycho Crusher if Cammy is interrupted at the right time
...
<03.07.2022>
 - Bug fixing
 - Changed Axle Spin Knuckle damage distribution
...
<12.06.2022>
 ...
 - Killer Bee Assault startup is invulnerable to fireballs
 - Replaced the taunt animation and gave Doll mode its own taunt, thanks to Potemkill
...
<30.04.2022>
 - Bug fixing
 - Restored ability to do Cannon Strike from Cannon Spike during Custom Combos
...
<24.04.2022>
 ...
 - Psycho Streak now calls in Vega behind Cammy
 - Changed timing, trajectory and height restriction of Hooligan Sting
 - Super cancel window for Cannon Drill is much longer
 - Heavy Axle Spin Knuckle can crossup the opponent
 - Psycho Streak can be super cancelled
 - Forward dash is more responsive
 - Fixed being able to dash over crouching (average-sized) characters
 - Air throws can no longer be teched
 - Buffed super damage
 - Adjusted both rolls
 - Added Messatsu's character trait recognition
 - Close hard kick knocks down and can be jump cancelled
 - Added a configuration file
 - Killer Bee Assault no longer stops after being parried once
...
==========< SPECIAL THANKS >==========
 ...
 - Potemkill, for the two taunts, Knee Bullet and Falling Arc animations
 ...
 - Tairano Lyon and ZolidSone, for feedback
