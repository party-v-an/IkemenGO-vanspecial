...
triggerall = command = "SonicHurricane"&&power>=1000
...
triggerall = command = "SomersaultStrike"&&power>=1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = (stateno = [200,499])
trigger3 = (stateno=[1000,1999])
...
triggerall = command = "CrossfireAssault"&&power>=1000
triggerall = statetype = A
trigger1 = ctrl
...
;---------------------------------------------------------------------------
; Crossfire Assault
[State -1, **NEW** Ground Crossfire Assault]
type = ChangeState
value = 3200
...
triggerall = command = "QCF_c"||command = "QCF_b"||command = "QCF_a"
;triggerall = statetype != A
trigger1 = ctrl
trigger2 = (stateno = [200,499])
...
;---------------------------------------------------------------------------
; Somersault
[State -1, Downward Somersault]
type = ChangeState
value = 1400

triggerall = command = "QCB_c"||command = "QCB_b"||command = "QCB_a"
triggerall = statetype = A
trigger1 = ctrl
trigger2 = (stateno = [600,699])
;---------------------------------------------------------------------------
...
triggerall = command = "HBF_z"||command = "HBF_y"||command = "HBF_x"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = (stateno = [200,499])
...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = (stateno = 210 || stateno = 240 || stateno = 410 || stateno = 440|| stateno = 200|| stateno = 400||stateno = 230|| stateno = 430||stateno=220)  && movecontact
;---------------------------------------------------------------------------
; Stand Strong Punch
...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = (stateno = 210 || stateno = 240 || stateno = 410 || stateno = 440|| stateno = 200|| stateno = 400||stateno = 230|| stateno = 430 || stateno = 450||stateno=250)  && movecontact
;---------------------------------------------------------------------------
; Standing Strong Kick
[State -1, Forward Fierce Kick]
type = ChangeState
value = 260
...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = (stateno = 210 || stateno = 240 || stateno = 410 || stateno = 440|| stateno = 200|| stateno = 400||stateno = 230|| stateno = 430 || stateno = 450)  && movecontact
ignorehitpause=1
;---------------------------------------------------------------------------
