...
===========================| Geese Howard by Phantom.of.the.Server |===========================
 ...
 - Customized version of SNK's Geese Howard character from the Fatal Fury series
...
==========< FEATURES >==========
 ...
 - Details and moves taken from his many video game appearances
...
.Shinkuu Nage                      F/B + pp
.Kosetsu Shou                      F/B + kk
.Raimei Gouha Nage                 D + pp (near downed opponent)
...
.Raikou Mawashi Geri               F + c
Target Combo 1                     (close) a, z
Target Combo 2                     (close) y, z
Target Combo 3                     (close) z, z
Target Combo 4                     (close) b, c
...
.Atemi Nage (EX)                   F, DF, D, DB, B, p
.Fake Reppuken                     D, DF, F, s


<SUPER>

.Raging Storm (MAX)                D, DB, B, DB, D, DF, F, p
...
.Deadly Rave                       F, DF, D, DB, B, F, kk
    .Deadly Rave Finish            x, x, a, a, y, b, z, c, D, DB, B, z
.Raging Dead End                   D, DB, B, D, DB, B, pp
...
==========< MOVE DETAILS >==========
 ...
 - Light Atemi Nage reverses jumping attacks, specials and supers
 - Medium Atemi Nage reverses mid-level normal attacks
 - Hard Atemi Nage reverses low normal attacks
 - All Atemi Nage moves share the same EX version, which reverses low and mid-level normal attacks
 - Raging Storm and Kyokuu Reppu Zan can negate projectiles
...
<27.09.2024>
 ...
 - EX Reppuken maximum number of hits are more limited
 - Standing Hard Kick now causes a free juggle state
...
<22.04.2024>
 ...
 - Standing hard kick now hits higher and has new properties
 - Raiko Mawashi Geri input changed
 - Removed command normal combo system
 - Added several target combos
 - Added a unique chip KO voice and a couple more hurt sounds
...
<05.10.2023>
 - Adjusted Deadly Rave damage scaling
 ...
 - Counter stances can now suffer from counter hits
 - Raging Dead End's super pause now only triggers upon a successful counter
 - Crouching friction constant reverted to Mugen standard
 - The counters now only work if the opponent is in front of Geese
 - EX Atemi Nage leaves the opponent closer to Geese
 - Raging Storm startup is more vulnerable to low attacks
 - Changed Raging Storm input
...
<30.07.2023>
 ...
 - Adjusted standing hard kick animation
 - Standing hard kick can be feinted
 - Updated Thunder Break special effects
 - Thunder Break vertical range increased and damage adjusted
 - Changed background color effects on super combo finishes
 - Changed the opponent's animation during MAX Kyoku Reppu Zan
 - Changed Custom Combo damage scaling
 - Removed the ability to perform EX and super moves at the end of Custom Combo
 - Jaeiken no longer activates in situations where it would obviously miss
 - Removed EX Shippuken follow-ups
 - EX Shippuken damage and juggle potential increased
 - Hisho Nichirin Zan and Jaeiken juggle potential adjusted
 - EX Reppuken is slightly harder to abuse
 - Hisho Nichirin Zan collision boxes adjusted. Also invulnerable to fireballs when Geese turns his back
...
<19.03.2023>
 ...
 - Slightly lowered the range on Atemi Nage
 ...
 - Added a classic sound effect to Rashoumon
 - Far standing medium kick can be cancelled into supers
 - Added a few voices from KOF All Stars

<11.09.2022>
 - Bug fixing
 - Added an experimental victory BGM
 - Lowered Kyoku Reppu Zan startup invulnerability
 - Each attack of Deadly Rave now adds to damage scaling
 ...
 - Added special intro compatibility with M. Bison by Froz
...
<30.04.2022>
 - Bug fixing
 - EX Jaeiken now triggers the burned animation on the opponent if they have one
...
<02.04.2022>
 ...
 - Fixed Hishou Nichirin Zan not adding stun
 - Nerfed EX Hishou Nichirin Zan juggle combos
 - Added some limited juggling ability to EX Jaeiken
 - Thunder Break is slightly less random and its juggle potential was increased
...
<24.03.2022>
 ...
 - Fixed a bug in the sound file that made a couple of sounds go missing
 - Reppukens are now drawn behind or in front of the characters depending on which hand Geese uses
 - If the first Reppuken in Double Reppuken is destroyed, the second one will be normal sized. Speed and damage properties are the same, however
 - Fireball super cancelling is no longer like SF3, but rather like most games. That is, the fireball needs to connect before Geese can super cancel
 - Raging Dead End stays active for a longer time
 - Adjusted hit velocities of Hishou Nichirin Zan
 - Hishou Nichirin Zan goes over low attacks more effectively, especially the medium and strong versions
 - Fake Reppuken is a bit slower
 - Raimei Gouha Nage can now be attempted at any time, just to let a new player know the command does something
 - Fixed MAX Rashoumon letting the opponent hit the ground just before Geese hits him
 - Extended horizontal range of EX Hishou Nichirin Zan (623pp)
 - Added a fitting background PalFX to Thunder Break
 - Tweaked hit behaviour of Gedan Atemi Nage (low counter) so that the opponent is no longer teleported to Geese
 - Fixed Raging Storm hitting 2 frames too late
 - Raging Storm startup is now fully invulnerable
 - Geese is invulnerable to projectiles during Raging Storm and Thunder Break while he's surrounded by energy
 - EX Reppuken can be super cancelled
 - EX Reppuken is now full screen, but lost some combo potential outside of corners
 - Thunder Break now causes a shocked animation if the opponent has one
 - Changed animation timing for Level 1 Rashoumon
 - Deadly Rave finisher command accepts either QCF or QCB
 - Forward dash is more responsive
 - Some moves were buffed a bit in terms of juggling
...
==========< SPECIAL THANKS >==========
 ...
 - DauntlessMonk, jay_ts and RagingRowen, for feedback
 - The Sudden Rarity, for the "Double Shippuken" voice
 - Mysticus and tatsudojo for some KOF14 and KOFAS voices
...
==========< DISCLAIMER >==========
 ...
 - The Geese Howard character is property of SNK
