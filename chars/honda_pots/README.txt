...
==========< MOVE DETAILS >==========
 ...
 - Mash punch buttons during MAX Fuji Oroshi to increase the number of hits
...
<23.11.2024>
 - Compatibility update for latest Ikemen version
 - Adjusted MAX Oni Musou visuals
 - MAX Fuji Oroshi now only allows mashing with punches
...
<27.09.2024>
 ...
 - Further adjusted Hundred Hand Slap to feel more like modern games
 - Jumping medium punch now knocks down when used air to air
 - Added more pixel animation to Hundred Hand Slap

<22.04.2024>
 - Bug fixing
 - Some throws now leave a mark on the floor
