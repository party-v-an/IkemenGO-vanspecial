...
local motif =
{
	...
	title_info =
	{
		...
		menu_pos = {159, 158},
		menu_tween_velocity = 3, --Ikemen feature
		...
		menu_boxcursor_tween_velocity = 3, --Ikemen feature
	...
	select_info =
	{
		...
		p1_cursor_tween_velocity = {0, 0}, --Ikemen feature
		...
		p2_cursor_tween_velocity = {0, 0}, --Ikemen feature
